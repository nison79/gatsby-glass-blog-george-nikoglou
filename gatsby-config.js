module.exports = {
  siteMetadata: {
    title: `The world from my View`,
    author: {
      name: `George Nikoglou`,
      summary: `Front End Developer & GatsbyJS Lover`,
    },
    description: `The place to expose my thoughts and point of view`,
    ...
    socialLinks: [
      ...
      {
        name: 'instagram',
        url: 'https://www.instagram.com/georgenikoglou/',
      },
    ],
  },
  plugins: [
